  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        {/* Contribution Card */}
        <div className="bg-amber-50 border border-amber-100 p-8 rounded-[2rem] flex flex-col items-center text-center shadow-sm">
          ...
          <h4 className="text-xl font-black text-amber-900 mb-2">Support the Creator</h4>
          ...
          <a 
            ...
            className="w-full bg-amber-500 hover:bg-amber-600 text-white font-black py-4 px-8 rounded-2xl transition-all shadow-lg shadow-amber-200 flex items-center justify-center space-x-2 active:scale-95"
          >
        ...
        {/* Share Card */}
        <div className="bg-indigo-50 border border-indigo-100 p-8 rounded-[2rem] flex flex-col items-center text-center shadow-sm">
          ...
          <h4 className="text-xl font-black text-indigo-900 mb-2">Share HiveTracker</h4>
          <p className="text-indigo-800/70 text-sm leading-relaxed mb-6">
            Know someone else struggling with chronic hives? Share this tool to help them find their patterns.
          </p>
          <button 
            onClick={handleShare}
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-black py-4 px-8 rounded-2xl transition-all shadow-lg shadow-indigo-200 flex items-center justify-center space-x-2 active:scale-95"
          >
      ...
      <div className="bg-white border border-slate-200 p-6 rounded-2xl flex items-start space-x-4 mt-8">
