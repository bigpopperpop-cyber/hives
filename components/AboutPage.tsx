    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-sm">
          ...
          <h3 className="text-xl font-black text-slate-800 mb-4 tracking-tight">The Log Entry System</h3>
          ...
          <ul className="space-y-4">
            <li className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">Use the slider (1-10) to record how intense the itch or swelling is.</p>
              </div>
            </li>
            <li className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">Select body areas. You can customize this list if you have unique spots.</p>
              </div>
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-sm">
          ...
          <h3 className="text-xl font-black text-slate-800 mb-4 tracking-tight">The Sync System</h3>
          <p className="text-slate-600 text-sm leading-relaxed mb-6">
          ...
          <ul className="space-y-4">
            <li className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">Your data never leaves your device unless you choose to export it.</p>
              </div>
            </li>
            <li className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">Download a .json file regularly to ensure you never lose your history.</p>
              </div>
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-sm">
          <div className="w-12 h-12 bg-cyan-500 text-white rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-cyan-100">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
            </svg>
          </div>
          <h3 className="text-xl font-black text-slate-800 mb-4 tracking-tight">Fetch Environment</h3>
          <p className="text-slate-600 text-sm leading-relaxed mb-6">
          ...
          <ul className="space-y-4">
            <li className="flex items-start space-x-3">
              <span className="bg-cyan-100 text-cyan-600 font-bold rounded-full w-5 h-5 flex items-center justify-center text-[10px] mt-1 shrink-0">1</span>
              <div>
                <p className="text-sm font-bold text-slate-800">Real-time Data</p>
                <p className="text-xs text-slate-500 leading-relaxed">We pull local temperature, humidity, and pollen levels using Open-Meteo APIs.</p>
              </div>
            </li>
            <li className="flex items-start space-x-3">
              <span className="bg-cyan-100 text-cyan-600 font-bold rounded-full w-5 h-5 flex items-center justify-center text-[10px] mt-1 shrink-0">2</span>
              <div>
                <p className="text-sm font-bold text-slate-800">Privacy Focused</p>
                <p className="text-xs text-slate-500 leading-relaxed">Your GPS coordinates are used only for the query and are <strong>never</strong> stored in your logs.</p>
              </div>
            </li>
          </ul>
        </section>
